  ...
  return (
    <div className="feature-page">
      ...
      <div className="filter-bar">
        ...
        <label>Profile<select value={profile} onChange={(event) => setProfile(event.target.value)}><option value="">All profiles</option><option value="active_trader">Active trader</option><option value="occasional_trader">Occasional trader</option><option value="defi_user">DeFi user</option><option value="points_airdrop_hunter">Points / airdrop hunter</option><option value="return_seeker">Exploring returns</option><option value="trading_team">Trading team</option><option value="researching">Researching</option></select></label>
        <label>Volume<select value={volume} onChange={(event) => setVolume(event.target.value)}><option value="">All volumes</option><option value="under_1k">Under $1k</option><option value="1k_10k">$1k-$10k</option><option value="10k_50k">$10k-$50k</option><option value="50k_100k">$50k-$100k</option><option value="100k_1m">$100k-$1m</option><option value="1m_plus">$1m+</option></select></label>
